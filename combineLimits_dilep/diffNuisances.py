...
if options.plotfile:
    ...
    hist_prefit.GetXaxis().SetRangeUser(0,25)
    ...
    canvas_nuis.SaveAs(options.plotfile.replace('.root','.pdf'))
    ...
    hist_prefit.GetXaxis().SetRangeUser(25,hist_prefit.GetNbinsX())
    hist_prefit.GetXaxis().LabelsOption("v")
    hist_prefit.Draw("E2")
    hist_prefit.Draw("histsame")
    gr_fit_b.Draw("EPsame")
    ...
    canvas_prop.SaveAs(options.plotfile.replace('.root','_bbb.pdf'))
