...
int main(int argc, char* argv[]){
  ...
  //double xbins[4] = {400, 500, 600, 700};
  ...
  //double xbins[15] = {200, 300, 400, 500.0, 600.0, 700.0, 800.0, 900.0, 1000.0, 1100.0, 1200.0, 1300.0, 1500.0, 1700.0, 3000.0};
  ...
  bool isCR = false;
  double maxHT = 500;
  if(argc>9) { std::string argv9(argv[9]); if (argv9=="CR") isCR = true; maxHT = HTcut; HTcut = 400;}
