...
systematicList = ['pileup','pdfNew20172018','muRFcorrdNew','jec2018','jer2018','Trig18','elIdSF2018']
...
# 	if discriminant != 'ST': continue
	...
	for isEM in isEMlist:
		...
		try: hQCD = RFile.Get(histPrefix+'__qcd').Clone()
			...
			pass
                print(histPrefix+'__FakeRate__NPWeight2018'+str(FRind))
		try: hDDBKG = RFile.Get(histPrefix+'__FakeRate__NPWeight2018'+str(FRind)).Clone()
		except:
		...
		try: hDDBKGstatOnly = hDDBKG.Clone(hDDBKG.GetName()+'statOnly')
                ...
                try: hDDBKGstatYr['17'] = RFile.Get(histPrefix.replace('1718','2017BF')+'__FakeRate__NPWeight2018'+str(FRind)).Clone(hDDBKG.GetName()+'statOnly17')
                except: pass
                ...
                try: hDDBKGstatYr['18'] = RFile.Get(histPrefix.replace('1718','2018AD')+'__FakeRate__NPWeight2018'+str(FRind)).Clone(hDDBKG.GetName()+'statOnly18')
                except: pass
