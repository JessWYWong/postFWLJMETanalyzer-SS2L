...
TH1* getPlot(Sample* s, TString hname, std::string var, int nxbins, double xbins[], std::string cut, int nMu, bool scale_, std::string addWeight = "1.0 * "){
  ...
  std::string cutstring = addWeight+" PUWeight * IDSF * IsoSF * trigSF * GsfSF * MCWeight * ChargeMisIDWeight * NPWeight* prefireWeight * ( "+cut+channel.str()+")";
...
int main(int argc, char* argv[]){
  ...
  double xbins[31];
  for(int i = 0; i<31; i++){ xbins[i] = 0+i*100;}//(600/30);}
  //double xbins[13];
  ...
  //double xbins[17] =  {190, 270, 350, 430, 510, 590, 670, 750, 830, 910, 990, 1070, 1150, 1230, 1390, 1550, 2990};
  //double xbins[13] = {500, 590, 670, 750, 830, 910, 990, 1070, 1150, 1230, 1390, 1550, 2990};
  //double xbins[6] = {1200, 1300, 1400, 1600, 1800, 3000};
  //double xbins[4] = {200, 300, 400, 500};
  //double xbins[11] = {500, 600, 700, 800, 900, 1000, 1200, 1400, 1600, 1800, 3000};
