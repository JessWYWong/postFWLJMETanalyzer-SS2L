...
def setTDRStyle():
    ...
    ROOT . gStyle . SetCanvasColor(ROOT.kWhite) # must be kWhite but I dunno how to do that in PyROOT
...
# For the Pad:
    ...
    ROOT . gStyle . SetPadColor(ROOT.kWhite); # kWhite
...
# For the statistics box:
    ...
    ROOT . gStyle . SetStatColor(ROOT.kWhite); # kWhite
