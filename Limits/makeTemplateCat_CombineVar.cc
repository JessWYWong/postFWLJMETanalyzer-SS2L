...
int main(int argc, char* argv[]){
  ...
  //for(int i = 0; i<31; i++){ xbins[i] = 0+i*(600/30);}
  ...
  bool isCR = false;
  double maxHT = 500;
  if(argc>10) { std::string argv10(argv[10]); if (argv10=="CR") isCR = true; maxHT = HTcut; HTcut = 200;}
  if(isCR && iplot == "cleanAK4HT" && !(xbins[nxbins]==maxHT)){std::cout<<"WARNING! HT upper cut not matching the defined bins up edge "<< xbins[nxbins-1] <<std::endl; return 1;}
