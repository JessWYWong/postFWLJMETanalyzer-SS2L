...
templateDir17 = 'optimization_082020/Lep1Pt40_Lep2Pt30_HT1200_nConst4'
templateDir18 = 'optimization_2018_082020/2018_Lep1Pt40_Lep2Pt30_HT1200_nConst4'
...
def add_systematics(cb):
	...
	signal = cb.cp().signals().process_set()
        ...
        cb.cp().process(['FakeRate']).channel(chns).AddSyst(cb, 'FakeRateSys$ERA', 'lnN', ch.SystMap('era')(['2017'], 1.106)(['2018'], 1.115))
        cb.cp().process(['ChargeMisID']).channel(chns).AddSyst(cb, 'ChargeMisIDSys$ERA', 'lnN', ch.SystMap('era')(['2017'], 1.314)(['2018'], 1.589))
        ...
        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.01918,0.98083))(['2018'],(1.01896,0.98104)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.0199,0.98011))(['2018'],(1.01933,0.98068)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.02011,0.9799))(['2018'],(1.01958,0.98043)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.0198,0.98021))(['2018'],(1.0192,0.98081)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.01969,0.98032))(['2018'],(1.01887,0.98113)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.01735,0.98265))(['2018'],(1.02061,0.97939)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.01991,0.9801))(['2018'],(1.01916,0.98085)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.02136,0.97864))(['2018'],(1.01807,0.98193)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.01688,0.98312))(['2018'],(1.01731,0.98277)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'TrigSys2017', 'lnN', ch.SystMap('mass')(['1000'],(1.01996,0.98005))(['1100'],(1.01995,0.98006))(['1200'],(1.01989,0.98012))(['1300'],(1.02015,0.97985))(['1400'],(1.01999,0.98002))(['1500'],(1.02014,0.97986))(['1600'],(1.0201,0.97991))(['1700'],(1.02007,0.97993))(['1800'],(1.02022,0.97978)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'TrigSys2018', 'lnN', ch.SystMap('mass')(['1000'],(1.01941,0.9806))(['1100'],(1.01945,0.98056))(['1200'],(1.01935,0.98066))(['1300'],(1.01939,0.98062))(['1400'],(1.01938,0.98062))(['1500'],(1.01941,0.98059))(['1600'],(1.01972,0.98029))(['1700'],(1.01956,0.98045))(['1800'],(1.01966,0.98035)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'TrigSys2017', 'lnN', ch.SystMap('mass')(['900'],(1.01975,0.98026))(['1000'],(1.02004,0.97997))(['1100'],(1.01982,0.98019))(['1200'],(1.01993,0.98008))(['1300'],(1.01984,0.98016))(['1400'],(1.01998,0.98003))(['1500'],(1.02004,0.97997))(['1600'],(1.02009,0.97992))(['1700'],(1.02002,0.97999))(['1800'],(1.02011,0.9799)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'TrigSys2018', 'lnN', ch.SystMap('mass')(['900'],(1.01944,0.98057))(['1000'],(1.01937,0.98063))(['1100'],(1.01944,0.98056))(['1200'],(1.01957,0.98044))(['1300'],(1.01929,0.98072))(['1400'],(1.01938,0.98062))(['1500'],(1.01956,0.98045))(['1600'],(1.0194,0.9806))(['1700'],(1.01945,0.98056))(['1800'],(1.01946,0.98055)))

        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.94751,1.05411))(['2018'],(0.96435,1.0362)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.9547,1.04633))(['2018'],(0.96105,1.0397)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.96102,1.03975))(['2018'],(0.96684,1.03371)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.95911,1.04187))(['2018'],(0.96424,1.03647)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.92404,1.07832))(['2018'],(0.95981,1.04098)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.87766,1.12814))(['2018'],(0.96003,1.04078)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.95153,1.0496))(['2018'],(0.95962,1.04122)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.96565,1.03494))(['2018'],(0.96118,1.03954)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.9471,1.05373))(['2018'],(0.96156,1.03925)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'lepIdSys2017', 'lnN', ch.SystMap('mass')(['1000'],(0.94904,1.05236))(['1100'],(0.95036,1.0509))(['1200'],(0.94673,1.05467))(['1300'],(0.9465,1.05497))(['1400'],(0.94774,1.05366))(['1500'],(0.94616,1.05533))(['1600'],(0.94396,1.05768))(['1700'],(0.94337,1.05829))(['1800'],(0.94227,1.0595)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'lepIdSys2018', 'lnN', ch.SystMap('mass')(['1000'],(0.96029,1.04052))(['1100'],(0.96056,1.0402))(['1200'],(0.95888,1.04198))(['1300'],(0.95986,1.04094))(['1400'],(0.96012,1.04071))(['1500'],(0.95965,1.04119))(['1600'],(0.95709,1.04383))(['1700'],(0.95352,1.04787))(['1800'],(0.95605,1.04502)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'lepIdSys2017', 'lnN', ch.SystMap('mass')(['900'],(0.94655,1.05486))(['1000'],(0.94906,1.05223))(['1100'],(0.94541,1.0561))(['1200'],(0.94647,1.05501))(['1300'],(0.94423,1.05736))(['1400'],(0.94198,1.05973))(['1500'],(0.94245,1.05925))(['1600'],(0.94378,1.05787))(['1700'],(0.93909,1.06273))(['1800'],(0.93756,1.06462)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'lepIdSys2018', 'lnN', ch.SystMap('mass')(['900'],(0.9549,1.04629))(['1000'],(0.96201,1.03873))(['1100'],(0.95999,1.0408))(['1200'],(0.96009,1.04074))(['1300'],(0.96007,1.04073))(['1400'],(0.95583,1.0451))(['1500'],(0.95854,1.04234))(['1600'],(0.95028,1.05149))(['1700'],(0.95484,1.04614))(['1800'],(0.94979,1.05131)))
        ...
        if era == '2017' : cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'pdfNew', 'lnN', ch.SystMap('mass')(['900'],(0.99381,1.00581))(['1000'],(0.9937,1.00528))(['1100'],(0.99565,1.00453))(['1200'],(0.98615,1.01432))(['1300'],(0.99226,1.00745))(['1400'],(0.99198,1.00782))(['1500'],(0.98143,1.01598))(['1600'],(0.99016,1.00848))(['1700'],(0.99125,1.00875))(['1800'],(1.00344,0.9979)))
        ...
        if era == '2017' : cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'muRFcorrdNewSig', 'lnN', ch.SystMap('mass')(['900'],(0.99496,1.00532))(['1000'],(0.99589,1.00406))(['1100'],(0.9944,1.00605))(['1200'],(0.99524,1.00549))(['1300'],(0.99587,1.00476))(['1400'],(0.99336,1.00711))(['1500'],(0.995,1.00606))(['1600'],(0.98794,1.01341))(['1700'],(0.98522,1.01539))(['1800'],(0.98258,1.01933)))
        ...
        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.96125,1.03341))(['2018'],(0.94526,1.05126)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.96826,1.02954))(['2018'],(0.9556,1.0456)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.96625,1.03845))(['2018'],(0.95462,1.05895)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.97464,1.02483))(['2018'],(0.96144,1.04133)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.97382,1.05236))(['2018'],(0.94118,1.05882)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.0,1.14286))(['2018'],(1.0,1.0)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.94828,1.04138))(['2018'],(0.96715,1.06569)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.0,1.0))(['2018'],(1.0,1.1)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.92857,1.0))(['2018'],(1.0,1.0625)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'jec2017', 'lnN', ch.SystMap('mass')(['1000'],(0.98737,1.01328))(['1100'],(0.98892,1.00894))(['1200'],(0.99036,1.00609))(['1300'],(0.99166,1.00426))(['1400'],(0.99217,1.00498))(['1500'],(0.99474,1.00401))(['1600'],(0.99411,1.00601))(['1700'],(0.99573,1.00596))(['1800'],(0.9945,1.00574)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'jec2018', 'lnN', ch.SystMap('mass')(['1000'],(0.98291,1.01553))(['1100'],(0.98692,1.01218))(['1200'],(0.9911,1.01083))(['1300'],(0.993,1.00864))(['1400'],(0.99369,1.00843))(['1500'],(0.99321,1.0068))(['1600'],(0.99134,1.00571))(['1700'],(0.99104,1.00835))(['1800'],(0.99223,1.00602)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'jec2017', 'lnN', ch.SystMap('mass')(['900'],(0.98333,1.01482))(['1000'],(0.98866,1.01579))(['1100'],(0.98511,1.01577))(['1200'],(0.99136,1.00668))(['1300'],(0.99398,1.00703))(['1400'],(0.9846,1.01175))(['1500'],(0.99396,1.0082))(['1600'],(0.99387,1.00486))(['1700'],(0.99436,1.0053))(['1800'],(0.9922,1.00574)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'jec2018', 'lnN', ch.SystMap('mass')(['900'],(0.97673,1.02057))(['1000'],(0.98791,1.01526))(['1100'],(0.98553,1.01581))(['1200'],(0.98834,1.01622))(['1300'],(0.986,1.01054))(['1400'],(0.98567,1.00998))(['1500'],(0.99198,1.01043))(['1600'],(0.9907,1.01234))(['1700'],(0.98172,1.01123))(['1800'],(0.99054,1.01034)))

        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.99065,1.00935))(['2018'],(0.99363,1.0029)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.99327,1.00522))(['2018'],(0.99747,1.00298)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.99487,1.00726))(['2018'],(0.99896,1.00365)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.99821,1.00393))(['2018'],(0.99913,1.00095)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.00524,1.04188))(['2018'],(1.0,1.0)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.92857,1.07143))(['2018'],(1.0,1.0)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(0.96897,0.99655))(['2018'],(1.00365,1.0146)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.0,1.0))(['2018'],(1.0,1.0)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'],(1.0,1.0))(['2018'],(1.0,1.0)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'jer2017', 'lnN', ch.SystMap('mass')(['1000'],(0.99966,1.00317))(['1100'],(0.99682,1.00298))(['1200'],(0.99962,0.9987))(['1300'],(0.99561,0.99987))(['1400'],(0.99812,1.00229))(['1500'],(0.99851,1.00588))(['1600'],(0.99858,1.00145))(['1700'],(0.99957,1.00444))(['1800'],(0.99526,1.00259)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'jer2018', 'lnN', ch.SystMap('mass')(['1000'],(0.99909,0.99943))(['1100'],(0.99858,1.00307))(['1200'],(0.99879,1.00236))(['1300'],(0.99945,1.00172))(['1400'],(0.99891,1.00147))(['1500'],(1.00125,1.00098))(['1600'],(0.99933,1.00183))(['1700'],(0.99711,1.00194))(['1800'],(0.99903,1.00008)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'jer2017', 'lnN', ch.SystMap('mass')(['900'],(0.99759,1.00042))(['1000'],(1.00292,1.00168))(['1100'],(0.99559,1.00783))(['1200'],(0.99986,0.99959))(['1300'],(0.99941,1.00243))(['1400'],(1.00123,1.01057))(['1500'],(0.99808,1.00356))(['1600'],(0.99495,1.00421))(['1700'],(0.9975,1.00219))(['1800'],(0.99806,1.00033)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'jer2018', 'lnN', ch.SystMap('mass')(['900'],(0.9995,0.99904))(['1000'],(0.99616,0.99982))(['1100'],(0.99908,1.00098))(['1200'],(0.99839,1.00368))(['1300'],(0.99546,1.00207))(['1400'],(1.00128,1.00322))(['1500'],(1.00059,1.00541))(['1600'],(0.99888,1.00226))(['1700'],(0.99807,1.00043))(['1800'],(0.99933,0.99955)))
...
if __name__ == '__main__':
	...
	era = "2017"
	rfile = fileDir17+'/templates_'+whichsignal+'_'+BRconfStr+'_Combine.root'
	print'File: ',rfile
	tfile17 = TFile(rfile)
	...
	print(chns)
	chnsEE = [chn for chn in chns if 'elel2017' in chn]
        chnsEM = [chn for chn in chns if 'elmu2017' in chn]
        chnsMM = [chn for chn in chns if 'mumu2017' in chn]
	...
	chns = [hist[:hist.find('__')] for hist in allHistNames if '__'+dataName in hist]
	print(chns)
	chnsEE = [chn for chn in chns if 'elel2018' in chn]
	chnsEM = [chn for chn in chns if 'elmu2018' in chn]
	chnsMM = [chn for chn in chns if 'mumu2018' in chn]
