...
def add_systematics(cb):
	...
	signal = cb.cp().signals().process_set()
        ...
        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'TrigSys$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))

        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'lepIdSys$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))
        ...
        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'jec$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))

        cb.cp().process(['TTZ']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTW']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTH']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTTT']).channel(chns).AddSyst(cb, 'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZ']).channel(chns).AddSyst(cb,   'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['ZZ']).channel(chns).AddSyst(cb,   'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WpWp']).channel(chns).AddSyst(cb, 'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WWZ']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['WZZ']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('era')(['2017'], (Up,Dn))(['2018'], (Up,Dn)))
        cb.cp().process(['TTM']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))
        cb.cp().process(['BBM']).channel(chns).AddSyst(cb,  'jer$ERA', 'lnN', ch.SystMap('mass')(['1000'], (Up,Dn)))
