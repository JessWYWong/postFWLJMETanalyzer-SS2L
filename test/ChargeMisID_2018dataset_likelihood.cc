...
int main(int argc, char* argv[]){
  ...
  if(argc==4 && (argv1.find("Data")!=std::string::npos || argv1.find("MC")!=std::string::npos ) && (argv2.find("25ns")!=std::string::npos || argv2.find("2018")!=std::string::npos) ) correctusage=true;
  if(!correctusage){
  ...
  if(argv1=="Data" && argv2=="50ns") {filename="root://cmseos.fnal.gov//store/user/clint/Run2015B/ljmet_trees/ljmet_Data_ElEl.root"; data=true; FiftyNS=true;}
      ...
      // Input file folder
      std::string filedir = "group/lpcljm/FWLJMET102X_2lep2018_wywong_082020_hadds";
  ...
  else outname=outdir+"/"+"ChargeMisID_likelihood_MC_Electrons_"+ID+".root";
