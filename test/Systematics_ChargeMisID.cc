...
int main(int argc, char* argv[]){
  ...
  //make treereader
  std::string filename;
  if(sample=="DYM50") filename = "/eos/uscms/store/user/lpcljm/FWLJMET102X_2lepSyst2018_wywong_082020_hadds/DYM50.root";
  else if (sample=="TTTo2L2Nu") filename = "/eos/uscms/store/user/wywong/FWLJMET102X_2lepSyst2018_wywong_082020_hadds/TTTo2L2Nu.root";
  else if (sample=="TTToSemiLeptonic") filename = "/eos/uscms/store/user/wywong/FWLJMET102X_2lepSyst2018_wywong_082020_hadds/TTToSemiLeptonic.root";
  else if (sample=="TT") filename = "/eos/uscms/store/user/lpcljm/FWLJMET102X_2lepSyst2018_wywong_082020_hadds/TT_hadd.root";
  else if(sample=="DYM50_FR") filename = "/eos/uscms/store/user/lpcljm/FWLJMET102X_2lepFakeRate2018_wywong_082020_hadds/DYM50.root";
  else if (sample=="TTTo2L2Nu_FR") filename = "/eos/uscms/store/user/lpcljm/FWLJMET102X_2lepFakeRate2018_wywong_082020_hadds/TTTo2L2Nu.root";
  else if (sample=="TTToSemiLeptonic_FR") filename = "/eos/uscms/store/user/lpcljm/FWLJMET102X_2lepFakeRate2018_wywong_082020_hadds/TTToSemiLeptonic.root";
