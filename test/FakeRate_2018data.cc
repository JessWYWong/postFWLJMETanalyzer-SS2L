...
int main(int argc, char* argv[]){
  ...
  if(data){
    if(MuonChannel) outname.push_back(outdir+"/"+"FakeRate_Data_"+argv4+"Muons_"+ID+"_2018dataset"+isoTrigStr+".root");
    else outname.push_back(outdir+"/"+"FakeRate_Data_"+argv4+"Electrons_"+ID+"_2018dataset"+isoTrigStr+".root");
  }
  else{
    if(MuonChannel){
      if(argv1=="WJets-MC") outname.push_back("FakeRate_WJets-MC_Muons"+ID+"_2018dataset.root");
      else if(argv1=="DYJets-MC") outname.push_back("FakeRate_DYJets-MC_Muons"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt0") outname.push_back("FakeRate_TTbar-MC_Muons_pt0"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt1") outname.push_back("FakeRate_TTbar-MC_Muons_pt1"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt2") outname.push_back("FakeRate_TTbar-MC_Muons_pt2"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt3") outname.push_back("FakeRate_TTbar-MC_Muons_pt3"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt4") outname.push_back("FakeRate_TTbar-MC_Muons_pt4"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt5") outname.push_back("FakeRate_TTbar-MC_Muons_pt5"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt6") outname.push_back("FakeRate_TTbar-MC_Muons_pt6"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt7") outname.push_back("FakeRate_TTbar-MC_Muons_pt7"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt8") outname.push_back("FakeRate_TTbar-MC_Muons_pt8"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt9") outname.push_back("FakeRate_TTbar-MC_Muons_pt9"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt15to30") outname.push_back("FakeRate_QCD_Pt15to30_Muons_"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt30to50") outname.push_back("FakeRate_QCD_Pt30to50_Muons_"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt50to80") outname.push_back("FakeRate_QCD_Pt50to80_Muons_"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt80to120") outname.push_back("FakeRate_QCD_Pt80to120_Muons_"+ID+"_2018dataset.root");
    }
    else{
      if(argv1=="WJets-MC") outname.push_back("FakeRate_WJets-MC_Electrons"+ID+"_2018dataset.root");
      else if(argv1=="DYJets-MC") outname.push_back("FakeRate_DYJets-MC_Electrons"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt0") outname.push_back("FakeRate_TTbar-MC_Electrons_pt0"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt1") outname.push_back("FakeRate_TTbar-MC_Electrons_pt1"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt2") outname.push_back("FakeRate_TTbar-MC_Electrons_pt2"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt3") outname.push_back("FakeRate_TTbar-MC_Electrons_pt3"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt4") outname.push_back("FakeRate_TTbar-MC_Electrons_pt4"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt5") outname.push_back("FakeRate_TTbar-MC_Electrons_pt5"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt6") outname.push_back("FakeRate_TTbar-MC_Electrons_pt6"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt7") outname.push_back("FakeRate_TTbar-MC_Electrons_pt7"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt8") outname.push_back("FakeRate_TTbar-MC_Electrons_pt8"+ID+"_2018dataset.root");
      else if(argv1=="TTbar-MC_pt9") outname.push_back("FakeRate_TTbar-MC_Electrons_pt9"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt15to30") outname.push_back("FakeRate_QCD_Pt15to30_Electrons_"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt30to50") outname.push_back("FakeRate_QCD_Pt30to50_Electrons_"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt50to80") outname.push_back("FakeRate_QCD_Pt50to80_Electrons_"+ID+"_2018dataset.root");
      else if(argv1=="QCD_MC-Pt80to120") outname.push_back("FakeRate_QCD_Pt80to120_Electrons_"+ID+"_2018dataset.root");
    }
  }
  ...
  if(argv1.find("Data")!=std::string::npos) {
    ...
    // Input folder 
    //std::string filedir = "FWLJMET102X_2lepFR2018_min1Jet_wywong_052020_hadds";
    std::string filedir = "FWLJMET102X_2lepFakeRate2018_wywong_082020_hadds";
    std::string elfiledir = filedir; //"FWLJMET102X_2lepFakeRate2018_062719_hadds";
    // Input files
    if(MuonChannel){
      //if(argv4=="2018A") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/DoubleMuon_FR_Run2018A.root");
      //else if(argv4=="2018B") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/DoubleMuon_FR_Run2018B.root");
      //else if(argv4=="2018C") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/DoubleMuon_FR_Run2018C.root");
      //else if(argv4=="2018D") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/DoubleMuon_FR_Run2018D.root");
      if(argv4=="2018A") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/SingleMuonRun2018A.root");
      else if(argv4=="2018B") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/SingleMuonRun2018B.root");
      else if(argv4=="2018C") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/SingleMuonRun2018C.root");
      else if(argv4=="2018D") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+filedir+"/SingleMuonRun2018D_rereco.root");
    }
    else if(!MuonChannel){
      //if(argv4=="2018A") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/DoubleEG_FR_Run2018A.root");
      //else if(argv4=="2018B") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/DoubleEG_FR_Run2018B.root");
      //else if(argv4=="2018C") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/DoubleEG_FR_Run2018C.root");
      //else if(argv4=="2018D") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/DoubleEG_FR_Run2018D.root");
      if(argv4=="2018A") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/SingleElectronRun2018A.root");
      else if(argv4=="2018B") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/SingleElectronRun2018B.root");
      else if(argv4=="2018C") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/SingleElectronRun2018C.root");
      else if(argv4=="2018D") filenames.push_back("root://cmseos.fnal.gov//store/group/lpcljm/"+elfiledir+"/SingleElectronRun2018D_rereco.root");
    }
  ...
  for(unsigned int i =0; i<filenames.size(); i++){
    std::cout<< "Running on file " << filenames.at(i)<<std::endl; 
    // Create output file
    ...
    for(int ient=0; ient<nEntries; ient++){
      ...
      bool muTrig_nonIso = tr->HLT_Mu20;//tr->HLT_Mu8;
      bool muTrig_nonIso_2 = false; //tr->HLT_Mu27;//tr->HLT_Mu17;
      bool muTrig_Iso = tr->HLT_Mu17_TrkIsoVVL; //tr->HLT_Mu8_TrkIsoVVL;
      bool muTrig_Iso_2 = false; //tr->HLT_Mu20;//tr->HLT_Mu17_TrkIsoVVL;
      ...
      bool elTrig_Iso = false; //tr->HLT_Ele12_CaloIdL_TrackIdL_IsoVL_PFJet30_v;
      ...
      n_pass1Lep_flav++;
      //skip events if is electron and found in hot spot
      if(HEMveto && (lep->isEl && lep->eta>-2.5 && lep->eta<-1.479 && lep->phi>-1.55 && lep->phi<-0.9)) continue;
...
std::vector<TLepton*> makeLeptons(std::vector<TMuon*> muons, std::vector<TElectron*> electrons, bool Muons, std::string ID){
  ...
  for(unsigned int uimu=0; uimu<muons.size(); uimu++){
    ...
    if(ID=="CBTight"){ // || ID=="MVA2017TightV2RC"){
    ...
    else if(ID=="CBTightMiniIsoTight"){ // || ID=="MVA2017TightV2IsoTightRC"){
      iLep->Tight=imu->cutBasedTightMiniIsoTight();
      iLep->Loose=imu->cutBasedLooseMiniIso();
    }
    else{iLep->Tight=false;iLep->Loose=false;}
    iLep->isMu = true;
    iLep->isEl = false;
...
//       if(iLep->pt>25 && iLep->pt<35) Leptons.push_back(iLep);
  ...
  for(unsigned int uiel=0; uiel<electrons.size(); uiel++){
    ...
    else if(ID=="MVA2017TightV2RC"){ // || ID=="CBTight"){
    ...
    else if(ID=="MVA2017TightV2IsoTightRC"){ // || ID=="CBTightMiniIsoTight"){
      iLep->Tight=iel->mva94XTightV2_90_IsoTight_RC();
      iLep->Loose=iel->mva94XLooseV2_Iso_RC();
    }
    else{
      iLep->Tight=false; iLep->Loose=false;
    }
