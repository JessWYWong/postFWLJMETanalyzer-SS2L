...
if __name__ == '__main__':
	...
	#bkg_samples['ZZ'] = '/ZZTo4L_TuneCP5_13TeV_powheg_pythia8/diLep2018/200920_225041/'#190905_072644/'
        ...
        #bkg_samples['DYM50'] = '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/diLep2018Syst/201127_233814/'
        #bkg_samples['TTTo2L2Nu'] = '/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/diLep2018Syst/201127_234600/'
        bkg_samples['TTToSemiLeptonic'] = '/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/diLep2018Syst/201201_043848/'
        #bkg_samples['TTToHadronic'] = '/TTToHadronic_TuneCP5_13TeV-powheg-pythia8/diLep2018Syst/201127_234845/'
	...
	#signal_samples['BpBp1000'] = '/BprimeBprime_M-1000_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_025157/'
	#signal_samples['BpBp1100'] = '/BprimeBprime_M-1100_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_025412/'
	#signal_samples['BpBp1200'] = '/BprimeBprime_M-1200_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_025524/'
	#signal_samples['BpBp1300'] = '/BprimeBprime_M-1300_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_025637/'
	#signal_samples['BpBp1400'] = '/BprimeBprime_M-1400_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_025755/'
	#signal_samples['BpBp1500'] = '/BprimeBprime_M-1500_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_025904/'
	#signal_samples['BpBp1600'] = '/BprimeBprime_M-1600_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_030050/'
	#signal_samples['BpBp1700'] = '/BprimeBprime_M-1700_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_030205/'
	#signal_samples['BpBp1800'] = '/BprimeBprime_M-1800_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018//'#190904_030314/'
...
#        rerun_samples['TpTp1800']='/TprimeTprime_M-1800_TuneCP5_PSweights_13TeV-madgraph-pythia8/diLep2018/190806_190701/'
	...
	os.system('eos root://cmseos.fnal.gov mkdir -p  %s' %eosdir)
        ...
        for samples in samples_to_process:
                ...
                for key in rootfile_paths.keys():
                        rootfile_path = rootfile_paths[key]
                        if len(rootfile_path) < nFilesPerHadd:
                                #Create condor files
                                PostLJMetHadd.create_condor_files_from_template(rel_base,cmssw,locdir,eosdir,[key],{key:rootfile_path},option.submit)
                        else:
                                n = 0
                                while n*nFilesPerHadd < len(rootfile_path) :
                                        IndDn = int(n*nFilesPerHadd)
                                        IndUp = int(min((n+1)*nFilesPerHadd,len(rootfile_path)))-1
                                        sub_rootfile_path = rootfile_path[IndDn:IndUp]
                                        subkey = key+"_"+str(n)
                                        print(subkey,n*nFilesPerHadd, min((n+1)*nFilesPerHadd,len(rootfile_path))-1)
                                        n+=1
                                        PostLJMetHadd.create_condor_files_from_template(rel_base,cmssw,locdir,eosdir,[subkey],{subkey:sub_rootfile_path},option.submit)
