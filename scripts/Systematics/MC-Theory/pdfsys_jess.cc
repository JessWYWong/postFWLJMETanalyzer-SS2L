...
void getPDFUnc(TFile* f, TString name, TString decay,std::stringstream& filecontent, bool isSig){
  ...
  TString nomcut = "ChargeMisIDWeight * NPWeight * IsoSF * trigSF * GsfSF * PUWeight * IDSF * MCWeight * (Lep1Pt>40 && nConst >=4 && (DilepMass>20) && ( (Channel!=0) ||(DilepMass<76.1 || DilepMass >106.1) ))";
  ...
  if(!isSig) t->Project("h_nom","cleanAK4HT",nomcut); //(TH1D*) f->Get("hist_scaleHT_nom");
  else{
  ...
  if(!usepdfSFsSym){ // SF from Julie (updated by Jess 28 Dec 2020) https://github.com/jmhogan/singleLepAnalyzer/blob/tptp_2018/makeTemplates/modifyBinning_byyear.py 
          ...
          if(name=="TTM1100") pdfSFsDn = 1.055;
          if(name=="TTM1200") pdfSFsDn = 1.060;
          if(name=="TTM1300") pdfSFsDn = 1.065;
          ...
          if(name=="BBM1800") pdfSFsSym = 0.113;
...
/*void getPDFUncYQM(TFile* f, TString name, TString decay,std::stringstream& filecontent){
  ...
  //SF from Julie (updated by Jess 30 Nov 2020) https://github.com/jmhogan/singleLepAnalyzer/blob/tptp_2017/makeTemplates/modifyBinning_byyear.py (year == 2018)
  if(name=="TTM1000") pdfSFsUp = 0.876;
  if(name=="TTM1100") pdfSFsUp = 0.874;
  if(name=="TTM1200") pdfSFsUp = 0.871;
  if(name=="TTM1300") pdfSFsUp = 0.867;
  if(name=="TTM1400") pdfSFsUp = 0.861;
  if(name=="TTM1500") pdfSFsUp = 0.852;
  if(name=="TTM1600") pdfSFsUp = 0.841;
  if(name=="TTM1700") pdfSFsUp = 0.829;
  if(name=="TTM1800") pdfSFsUp = 0.817;

  if(name=="TTM1000") pdfSFsDn = 1.165;
  if(name=="TTM1100") pdfSFsDn = 1.168;
  if(name=="TTM1200") pdfSFsDn = 1.174;
  if(name=="TTM1300") pdfSFsDn = 1.181;
  if(name=="TTM1400") pdfSFsDn = 1.192;
  if(name=="TTM1500") pdfSFsDn = 1.211;
  if(name=="TTM1600") pdfSFsDn = 1.233;
  if(name=="TTM1700") pdfSFsDn = 1.259;
  if(name=="TTM1800") pdfSFsDn = 1.290;

  if(name=="BBM900") pdfSFsUp = 0.877;
  if(name=="BBM1000") pdfSFsUp = 0.875;
  if(name=="BBM1100") pdfSFsUp = 0.874;
  if(name=="BBM1200") pdfSFsUp = 0.871;
  if(name=="BBM1300") pdfSFsUp = 0.867;
  if(name=="BBM1400") pdfSFsUp = 0.862;
  if(name=="BBM1500") pdfSFsUp = 0.852;
  if(name=="BBM1600") pdfSFsUp = 0.841;
  if(name=="BBM1700") pdfSFsUp = 0.830;
  if(name=="BBM1800") pdfSFsUp = 0.817;

  if(name=="BBM900") pdfSFsDn = 1.163;
  if(name=="BBM1000") pdfSFsDn = 1.167;
  if(name=="BBM1100") pdfSFsDn = 1.168;
  if(name=="BBM1200") pdfSFsDn = 1.174;
  if(name=="BBM1300") pdfSFsDn = 1.182;
  if(name=="BBM1400") pdfSFsDn = 1.191;
  if(name=="BBM1500") pdfSFsDn = 1.210;
  if(name=="BBM1600") pdfSFsDn = 1.233;
  if(name=="BBM1700") pdfSFsDn = 1.259;
  if(name=="BBM1800") pdfSFsDn = 1.289;
