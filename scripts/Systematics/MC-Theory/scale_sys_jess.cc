...
for(unsigned int j=0; j<h1->GetNbinsX();j++){
  ...
  //SF from Julie (updated by Jess 28 Dec 2020) https://github.com/jmhogan/singleLepAnalyzer/blob/tptp_2018/makeTemplates/modifyBinning_byyear.py
  float scaleSFsUp = 1.0;
  float scaleSFsDn = 1.0;
  if(name=="TTM900") scaleSFsUp = 0.744;
  if(name=="TTM1000") scaleSFsUp = 0.743;
  if(name=="TTM1100") scaleSFsUp = 0.737;
  if(name=="TTM1200") scaleSFsUp = 0.740;
  if(name=="TTM1300") scaleSFsUp = 0.741;
  if(name=="TTM1400") scaleSFsUp = 0.737;
  if(name=="TTM1500") scaleSFsUp = 0.737;
  if(name=="TTM1600") scaleSFsUp = 0.734;
  if(name=="TTM1700") scaleSFsUp = 0.735;
  if(name=="TTM1800") scaleSFsUp = 0.740;

  if(name=="TTM900") scaleSFsDn = 1.312;
  if(name=="TTM1000") scaleSFsDn = 1.314;
  if(name=="TTM1100") scaleSFsDn = 1.323;
  if(name=="TTM1200") scaleSFsDn = 1.318;
  if(name=="TTM1300") scaleSFsDn = 1.318;
  if(name=="TTM1400") scaleSFsDn = 1.324;
  if(name=="TTM1500") scaleSFsDn = 1.324;
  if(name=="TTM1600") scaleSFsDn = 1.328;
  if(name=="TTM1700") scaleSFsDn = 1.330;
  if(name=="TTM1800") scaleSFsDn = 1.321;

  if(name=="BBM900") scaleSFsUp = 0.744;
  if(name=="BBM1000") scaleSFsUp = 0.742;
  if(name=="BBM1100") scaleSFsUp = 0.742;
  if(name=="BBM1200") scaleSFsUp = 0.741;
  ...
  if(name=="BBM1700") scaleSFsUp = 0.720;
  if(name=="BBM1800") scaleSFsUp = 0.855;

  if(name=="BBM900") scaleSFsDn = 1.312;
  if(name=="BBM1000") scaleSFsDn = 1.315;
  if(name=="BBM1100") scaleSFsDn = 1.316;
  if(name=="BBM1200") scaleSFsDn = 1.318;
  if(name=="BBM1300") scaleSFsDn = 1.317;
  if(name=="BBM1400") scaleSFsDn = 1.321;
  if(name=="BBM1500") scaleSFsDn = 1.328;
  if(name=="BBM1600") scaleSFsDn = 1.329;
  if(name=="BBM1700") scaleSFsDn = 1.356;
  if(name=="BBM1800") scaleSFsDn = 1.272;
