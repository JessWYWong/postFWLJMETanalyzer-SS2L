...
void combinedSignal(TString mass, int BRtype){
  ...
  if (mass=="1300"){ Xsec = 0.00639; NEvts = 1026082.979;} //831000.;}
  if (mass=="1400"){ Xsec = 0.00354; NEvts = 979603.275;} //832600.;}
  if (mass=="1500"){ Xsec = 0.00200; NEvts = 985756.619;} //832800.;}
  if (mass=="1600"){ Xsec = 0.001148; NEvts = 989851.281;} //832600.;}
  if (mass=="1700"){ Xsec = 0.000666; NEvts = 939135.751;} //797000.;}
