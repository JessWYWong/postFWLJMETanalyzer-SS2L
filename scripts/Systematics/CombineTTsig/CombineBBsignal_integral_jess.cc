...
void combinedSignal(TString mass, int BRtype){
  ...
  if (mass=="900"){ Xsec = 0.0903; NEvts = 959939.583 * 687000.0 / 817000.0;}
  if (mass=="1000"){ Xsec = 0.0440; NEvts = 1011510.550;}
  if (mass=="1100"){ Xsec = 0.0224; NEvts = 969137.000;} //832800.;}
  if (mass=="1200"){ Xsec = 0.0118; NEvts = 1027818.122;} //832600.;}
  if (mass=="1300"){ Xsec = 0.00639; NEvts = 917763.768;} //831000.;}
  if (mass=="1400"){ Xsec = 0.00354; NEvts = 877071.614;} //832600.;}
  if (mass=="1500"){ Xsec = 0.00200; NEvts = 804769.156;} //832800.;}
  if (mass=="1600"){ Xsec = 0.001148; NEvts = 895604.498;} //832600.;}
  if (mass=="1700"){ Xsec = 0.000666; NEvts = 946782.494;} //797000.;}
  ...
  TString nomcut = "ChargeMisIDWeight * NPWeight * IsoSF * trigSF * GsfSF * prefireWeight * PUWeight * IDSF * MCWeight * (Lep1Pt>40 && Lep2Pt>30 && nConst >=4 && (DilepMass>20) && ( (Channel!=0) ||(DilepMass<76.1 || DilepMass >106.1) ) && cleanAK4HT > 1200) * pdfWeights4LHC[0] ";
