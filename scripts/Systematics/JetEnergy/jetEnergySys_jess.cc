...
/*
  ...
  TRegexp reHT("cleanAK4HT");
  TString jesUpcut = nomcut; jesUpcut(reNconst) = "nConstJESup"; jesUpcut(reHT) = "cleanAK4HTScaleUp";
  TString jesDowncut = nomcut; jesDowncut(reNconst) = "nConstJESdn"; jesDowncut(reHT) = "cleanAK4HTScaleDown";
  TString jerUpcut = nomcut; jerUpcut(reNconst) = "nConstJERup"; jerUpcut(reHT) = "cleanAK4HTSmearUp";
  TString jerDowncut = nomcut; jerDowncut(reNconst) = "nConstJERdn"; jerDowncut(reHT) = "cleanAK4HTSmearDown";
*/  
